...
#Figure S4C and S4D - Screenshots from the 3D object 
...
maternal_stroma$stromatype[which(str_detect(maternal_stroma$strsubset, "Str0"))] <- "udStr"
...
```{r}
maternal_stroma_pdz <- subset(x = maternal_stroma ,subset = stromatype == c("udStr","PDZ1","PDZ2"))
...
```{r}
maternal_stroma_sdz <- subset(x = maternal_stroma ,subset = stromatype == c("udStr","SDZ1","SDZ2"))
...
#Figure 4D Statistical Analysis - Kolmogorov-Smirnov Test 
```{r}
...
#Figure S4E - Slingshot pseudotime / UMAP
