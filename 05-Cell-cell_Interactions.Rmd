...
#Figure 6.3A and Supplemental File 6.1 - Ranknet comparison
```{r}
...
#Figure 6.3B - Desmosterol Circleplot
```{r}
...
#Figure 6.3C - Desmosterol Enriched L-R ViolinPlot
...
#Figure 6.3D - GALECTIN Circleplot
```{r}
...
#Figure 6.3E - GALECTIN Enriched L-R ViolinPlot
