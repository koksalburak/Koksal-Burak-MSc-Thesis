...
#Supplemental File 4.2: Finding the markers / Cluster annotation
```{r}
...
my_levels <- c("S1", "S2", "S3", "S4", "S5","SMC", "Endo1", "Endo2",  "Epi", "Meso", "T", "NK", "ILC-Like",  "cDC1", "cDC2", "Mφ")
...
maternal_majorsub <- subset(x = maternal_integrated, idents = c("S1","S2","S3","S4","S5","Mφ","NK"))
